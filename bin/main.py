...
import time
LICNECE = """
Attached Succesfully Getting Proxies & Running Generator"""
...
try:
    ...
    print("Requirements & Internet check")
    time.sleep(.4)
    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by ! omanx#3054")  # Change the
        else:  # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker - Made by ! omanx#3054\a',
...
""")  # Print the title card
        ...
        self.slowType("Made by: ! omanx#3054", .02)
        ...
        if USE_WEBHOOK:
            ...
            if webhook is not None: # Gets Proxy From proxy.exe automatically
        ...
        valid = []  # Keep track of valid codes & Checks w proxies from Proxy.exe
        ...
        for s in c:  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by ! omanx#3054")  # Change the title
                print("")
            else:  # If it is a unix system
                # Change the title
                print(
                    f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by ! omanx#3054\a', end='', flush=True)
